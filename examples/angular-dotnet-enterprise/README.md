...
cd your-angular-dotnet-project

# 2. Initialize Magneto with the power packs
magneto init --with typescript angular ngrx angular-material csharp dotnet cqrs sql-server entity-framework azure-ad signalr azure azure-devops

# 3. Run analysis
magneto analyze

# 4. Start using magneto commands
magneto query "payroll approval"
```
