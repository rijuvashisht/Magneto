...
function writeTaskSchemas(projectRoot: string): void {
  ...
  writeJson(path.join(tasksDir, 'task-schema.json'), {
    $schema: 'http://json-schema.org/draft-07/schema#',
    title: 'Magneto AI Task',
    type: 'object',
  ...
  writeJson(path.join(tasksDir, 'result-schema.json'), {
    $schema: 'http://json-schema.org/draft-07/schema#',
  ...
  writeJson(path.join(tasksDir, 'contradiction-schema.json'), {
    $schema: 'http://json-schema.org/draft-07/schema#',
